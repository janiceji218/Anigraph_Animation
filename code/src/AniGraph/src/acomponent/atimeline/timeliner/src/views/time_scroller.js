...
function ScrollCanvas(dispatcher, data) {
	var width, height;
	// this.visible_time_range = [0,0];//added by Abe
	...
	this.paint = function(ctx) {
		...
		var grip_length = w * k;
		// data.set('visible_time_range').value([scrollTime, grip_length*pixels_per_second]);
		dispatcher.fire('update.visibleTimeRange', [scrollTime, scrollTime+(w/pixels_per_second)]);
